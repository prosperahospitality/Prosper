...
const AboutUs = () => {
  return (
    <div className="w-full flex justify-center items-center mt-10 md:mt-16">
      <div className="flex flex-col justify-center items-center lg:w-[80%] w-[90%] gap-16">
        ...
        <div className="mt-4 text-center relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-11 mt-4">
            ...
            <p className="text-base sm:text-lg md:mt-4 font-normal text-gray-500 text-justify">
