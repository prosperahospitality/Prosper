        ...
        <div className="container">
          <div className="card">
            ...
            <div className="total-in-words">
              <span>IN WORDS: {numberToWords(parseInt(data[0].tabTotalAmount.replace(/,/g, ''), 10))}</span>
            </div>

            {
              data[0].note === ""
                ...
                : <div className="pfooter">
                  <div className="pnote">
                    <div className='psubnote'>
                      <div className='psubsubnote'>
                        <div>NOTE: </div><div> {data[0].note}</div>
                      </div>
          ...
          <div className="card">
            <div className="header">
              <div className="plogo-container">
                <img
                  src="http://localhost:3000/img/prosperalogo.jpg"
                  className="logo"
                  alt="logo"
                />
              </div>
              <div className="pcontact-img-container">
                <img
                  src={`http://localhost:3000/img/prosperacontact.jpg`}
                  className="contact-img"
                  alt="contact"
                />
              </div>
            ...
            <div className="second-section">
              <div className="payment-details">
                <div className="subsection">
                  <h2 className="text-xs mb-1">Payment Details:</h2>
                  <p className="text-xs">Bank Transfer: Prospera Hospitality Pvt Ltd.Bank</p>
                  <p className="text-xs">Account No: 924020020697546, Name: Axis Bank Ltd</p>
                  <p className="text-xs">IFSC Code: UTIB0001965, MICR Code: 400211127</p>
                  <p className="text-xs">SWIFT Code: AXISINBB</p>
                  <p className="text-xs">GST NO: 27AAOCP5388B1Z2</p>
                </div>
              </div>
              <div className="hotel-details">
                <div className="subsection">
...

            {
              data[0].note === ""
                ? <div className="footer">
                  <div className="signature">
                    <div className="authorised-signatory">
                      <span>For Prospera Hospitality</span>
                    </div>
                    <div className="signature-img-container">
                      <img
                        src={`http://localhost:3000/img/prosperasign.png`}
                        className="signature-img"
                        alt="signature"
                      />
                    </div>
